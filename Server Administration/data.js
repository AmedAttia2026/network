const quizData = {
    ...
    'serverAdminQuiz': {
        ...
        data: [
            ...
            // Note: For 'True_False', the 'correct' field indicates the True/False status. The correction is added in 'correction' field.
            ...
            { 
                ...
                // This question is an 'Association' type but represented as MCQ for simplicity, where the user must know all correct associations.
                // Assuming a simplified implementation where the user checks all correct pairs.
                // In a real application, this might be a drag-and-drop/matching question.
                correct: [0, 1, 2, 3] // All options are correct statements
            },
            { 
                type: 'arrangement', 
                q: "18. Arrange the next compounds from the basic layer to higher:", 
                options: [
                    "A. Physical Volume (PV)",
                    "B. Logical Volume (LV)",
                    "C. Volume Group (VG)"
                ], 
                // The correct order is PV -> VG -> LV, which corresponds to indices [0, 2, 1]
                correct_order: [0, 2, 1] 
            },

            // ---
            // Part 4: Technical Terms
            { type: 'text', q: "19. A method for combining multiple partitions on different disks into one large virtual device", correct: "RAID" },
            { type: 'text', q: "20. The storage management system that offers enhanced flexibility, scalability, and reliability in Linux", correct: "LVM" },
            ...
            // ---
            // Part 5: Short Answer
            { type: 'text', q: "24. What are two advantages of using RAID in server environments?", correct: "Data redundancy and Higher performance." },
            { type: 'text', q: "25. What are two benefits of LVM compared to traditional partition management?", correct: "Flexible capacity and Snapshots." },
            { type: 'text', q: "26. Name two reasons why Linux might be preferred over Windows for server environments.", correct: "Cost and Performance/Efficiency." },
            ...
            { 
                ...
                correct: "RAID 6, which uses Double Parity to survive two simultaneous disk failures."
            },
            { 
                type: 'text', 
                ...
                correct: "Centralized Package Manager. It automates installation, updates, and dependency management from trusted repositories."
            }
        ]
    }
};
